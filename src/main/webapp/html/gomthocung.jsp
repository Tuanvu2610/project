...
<nav class="menu-home">
    <ul class="cover-menu">
        ...
        <li class="sub-item"><a class="tab" data-target="main-thocung" href="#">GỐM THỜ CÚNG</a><i class="bi bi-chevron-down"></i>
            <div class="sub-menu">
                <ul class="hover">
        ...
        <li class="sub-item"><a href="gom-qua-tang">GỐM QUÀ TẶNG</a><i class="bi bi-chevron-down"></i>
            <div class="sub-menu">
                <ul class="hover">
